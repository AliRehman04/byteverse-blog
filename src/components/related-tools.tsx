...
const TOOLS: Record<string, { name: string; desc: string; icon: LucideIcon; color: string }> = {
  ...
  "youtube-data-extractor": { name: "YouTube Data Extractor", desc: "Extract thumbnail, title & tags", icon: MonitorPlay, color: "text-rose-500" },
};
...
const RELATED: Record<string, string[]> = {
  ...
  "youtube-tag-generator": ["youtube-data-extractor", "meta-tag-generator", "slug-generator", "og-preview"],
  "youtube-data-extractor": ["youtube-tag-generator", "og-preview", "meta-tag-generator", "slug-generator"],
};
