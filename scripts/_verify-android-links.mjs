...
const [row] = await sql`SELECT content, cover_image FROM posts WHERE slug = 'best-ai-apps-for-android-2026'`;
...
if (toolLinks.length) console.log(`Tool links: ${[...new Set(toolLinks)].join(', ')}`);
