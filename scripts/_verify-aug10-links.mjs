...
const slug = "how-to-use-notebooklm-2026-complete-guide";
const [post] = await sql`SELECT content, meta_title, meta_description FROM posts WHERE slug = ${slug}`;
...
console.log(bad === 0 ? "All link targets published ✓" : `${bad} bad targets!`);
