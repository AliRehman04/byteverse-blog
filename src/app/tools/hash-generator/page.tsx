...
export const metadata: Metadata = {
  ...
  description:
    "Generate SHA-1, SHA-256, SHA-384, and SHA-512 hashes instantly. Free online hash calculator using Web Crypto API. Secure, private, runs in your browser.",
  keywords: [
    "hash generator",
    "sha256 hash",
    "sha512 hash",
  ...
  alternates: { canonical: "https://www.byteverse.fyi/tools/hash-generator" },
};
