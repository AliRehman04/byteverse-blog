...
const slug = 'how-to-use-n8n-2026-complete-guide';
const title = 'How to Use n8n in 2026: Complete Beginner Guide';
const metaTitle = 'How to Use n8n in 2026: Beginner Tutorial (Free + AI)';
const metaDescription = 'Learn how to use n8n in 2026: run it free locally or in the cloud, build your first workflow step by step, use templates safely, and add your first AI agent.';
const excerpt = 'A genuine beginner path into n8n: the five concepts that make it click, the official first workflow explained step by step, template safety rules, and your first AI agent with human approval.';
const keywords = 'how to use n8n, n8n tutorial for beginners, n8n tutorial 2026, how to use n8n for free, how to use n8n locally, n8n docker, n8n ai agent tutorial, n8n workflow examples, n8n templates, n8n cloud vs self hosted';
const summary = 'n8n clicks once you know five concepts — triggers, nodes, credentials, expressions, executions — and build one real workflow end to end before scaling up.|Start on Cloud (fastest) or free locally via the documented one-line install or Docker; free software still means real hosting, update, and security responsibility.|Add AI gradually: a tight system message, one read-only tool first, and human-in-the-loop approval before any agent action that changes external systems.';
const content = (await readFile(new URL('./content/how-to-use-n8n-2026.md', import.meta.url), 'utf8')).trim();
const coverImage = 'https://images.pexels.com/photos/1181311/pexels-photo-1181311.jpeg?auto=compress&cs=tinysrgb&w=1400';
